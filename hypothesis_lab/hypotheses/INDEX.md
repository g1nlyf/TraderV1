...
| H-171 | Wallet adds incremental multivariate OOS value | **tested · REVISES wallet-dead** | token+wallet edge +11.36% vs token-only +9.81%; OOS Spearman +0.474 vs +0.400 (perm 0.000) | — | 1137 | 2026-06-06 | Beat-token-only gate: multivariate GBM shows wallet/cohesion/wq features add +1.55% edge & +0.074 Spearman over token-only. Sprint-7 univariate kill was too harsh. Best ranker yet (CI upper +0.24%). Still neg EV (down-regime); needs walk-forward + cross-day. H170_TOKEN_LIFECYCLE_REPORT.md |
